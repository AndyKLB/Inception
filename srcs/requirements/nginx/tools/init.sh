...
## nginx -t test, sans lancer, la syntaxe et validite des fichiers si erreur set -e arrete
...
# -nodes	Pas de mot de passe sur la clé privee pour demarrage direct (no DES encryption)
# -days 365	Certificat valide 365 jours
# -newkey rsa:2048	Crée une nouvelle clé RSA de 4096 bits
